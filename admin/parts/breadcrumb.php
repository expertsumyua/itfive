<?php
    ...
    if ($page == "Категории" || $page == "Редактировать категорию" || $page == "Удалить категорию" || $page == "Заказы" || $page == "Услуги" || $page=="Добавить категорию" || $page == "Изменить категорию услуг" || $page == "Изменить услуги" || $page == "Добавить услуги" || $page == "Пользователи" || $page == "Изменить пользователя") {
