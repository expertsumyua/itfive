<?php
	...
	if ($page == "Категории" || $page == "Редактировать категорию" || $page == "Удалить категорию" || $page == "Заказы" || $page == "Услуги" || $page=="Добавить товар" || $page == "Изменить категорию услуг" || $page == "Изменить услуги" || $page == "Добавить услуги") {
